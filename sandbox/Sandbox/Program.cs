...
class Program
{
    static void Main(string[] args)
    {
        ...
        fraction5.SetTopNumber(7);
        fraction5.SetBottomNumber(8);
        Console.WriteLine(fraction5.GetFractionString()); // Output: 7/8
        Console.WriteLine(fraction5.GetDecimalValue());   // Output: 0.875
    }
}
